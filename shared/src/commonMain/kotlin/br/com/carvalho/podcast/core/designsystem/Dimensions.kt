...
object AppDimensions {
    ...
    val iconNormal = 28.dp
    val iconLarge = 32.dp
    val iconExtraLarge = 40.dp

    val touchTarget = 48.dp
    val progressBarHeight = 3.dp
    val miniProgressBarHeight = 2.dp
    val playButtonSize = 72.dp
    val miniPlayerHeight = 64.dp
    val miniPlayerHeightWithPadding = 80.dp
    val episodeImageSize = 56.dp
    val episodeDetailImageSize = 100.dp
    val headerImageSize = 100.dp
