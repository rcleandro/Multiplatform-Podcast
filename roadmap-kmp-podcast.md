...
*   [x] **Firebase Remote Config:** Implementar controle remoto de flags de funcionalidades e constantes de negócio (ex: intervalos de skip) sem necessidade de novo deploy.
